...
export const DigitalCatalogsSection: React.FC<DigitalCatalogsSectionProps> = ({
  ...
  return (
    <section className="space-y-8 text-right" id="catalogs-section">
        ...
        {catalogs.map((catalog) => {
          return (
            <div
              ...
              className="group rounded-2xl bg-[#090d1a] border border-white/10 hover:border-emerald-500/60 transition-all duration-300 p-3.5 space-y-3 cursor-pointer shadow-lg hover:shadow-2xl hover:shadow-emerald-500/10 flex flex-col justify-between"
            >
              {/* Cover Mockup */}
      ...
      {/* Interactive Mobile Flipbook & PDF Modal Viewer */}
      {activeCatalog && (
