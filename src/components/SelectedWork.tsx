      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/10">
        <div className="space-y-1.5">
          <div className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-[#0066FF]">
            ...
            <span>ویترین راهبردی برای مدیریت ارشد</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight leading-relaxed">
            ۱۰ پروژه برگزیده و شاخص تیم طراحی
          </h1>
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
            مهم‌ترین پروژه‌ها، پورتال‌های ملی و سامانه‌های دیجیتال طراحی‌شده با بالاترین سطح اثرگذاری
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 self-start md:self-auto">
          {onOpenPresentation && (
            ...
            >
              ...
              <span>ارائه تمام‌صفحه به مدیرعامل</span>
            </button>
          )}
        </div>
      </div>
