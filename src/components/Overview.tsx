...
import { Project, MetricSummary, SiteKpiCard } from '../types';
...
export const Overview: React.FC<OverviewProps> = ({
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 pb-16 space-y-16 text-right">
          ...
          <div className="relative z-10 max-w-4xl space-y-7">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              ...
              >
                ...
                <span>{hero.ctaSecondaryText || 'بررسی ۱۰ پروژه شاخص'}</span>
              </button>
      ...
      {/* ------------------------------------------------------------- */}
      {/* 3. TOP 10 STRATEGIC FLAGSHIPS (DYNAMIC VISIBILITY & TITLES) */}
      {/* ------------------------------------------------------------- */}
      {sections.showTop10 && (
        <section id="top10-section" className="space-y-7">
            ...
            <div>
              <div className="flex items-center gap-2.5">
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight">
                  {sections.top10SectionTitle || 'پروژه‌های شاخص'}
                </h2>
              </div>
              <p className="text-xs sm:text-sm text-slate-400 mt-1">
                {sections.top10SectionSubtitle || '۱۰ نمونه‌کار برتر با بالاترین اثرگذاری'}
              </p>
            </div>
          ...
          {/* 10 Projects Clean Gallery Grid */}
