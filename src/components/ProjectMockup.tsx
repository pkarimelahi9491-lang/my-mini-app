...
export const ProjectMockup: React.FC<ProjectMockupProps> = ({
  ...
  // Get responsive realistic images
  const desktopImg = getProjectImage(project.id, project.type, 'hero');
  const tabletImg = getProjectImage(project.id, project.type, 'gallery');
  const mobileImg = getProjectImage(project.id, project.type, 'mobile');
