    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-[#07080d]/80 backdrop-blur-xl border-b border-white/10 transition-all">
      <div className="max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8 h-14 sm:h-16 lg:h-[70px] flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0 h-full">
          ...
          <button
            onClick={onOpenCMS}
            className="flex items-center gap-1.5 px-2.5 sm:px-3 h-8 sm:h-9 rounded-lg hover:bg-white/10 text-slate-300 hover:text-white text-xs font-medium transition-all cursor-pointer"
            title="مدیریت محتوا"
          >
            <SlidersHorizontal className="w-4 h-4 text-[#0066FF]" />
            <span className="hidden xl:inline">مدیریت محتوا</span>
          </button>
