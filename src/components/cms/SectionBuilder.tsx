...
import { Plus, Trash2, ArrowUp, ArrowDown, Eye, EyeOff, Layers, FileText, BarChart2, Smartphone, GitCommit, LayoutGrid, Quote } from 'lucide-react';
          ...
          sections.map((section, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Content Textarea if text or hero */}
                {['hero', 'text', 'ux-flow', 'quote'].includes(section.type) && (
                  <div>
